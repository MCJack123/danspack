local LibDeflate = require "filters.luz.LibDeflate"
local maketree = require "filters.luz.maketree"
local lz77 = require "filters.luz.lz77"
local token_encode_map = require "filters.luz.token_encode_map"
local lex = require "filters.luz.lex"
...
return function(data, level)
    assert(load(data))
    return compress(lex(data, 1, 2), level)
end
